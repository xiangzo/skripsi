    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                <div class="col-lg-8 mb-4 order-0">
                    <div class="card">
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-8">
                                <div class="card-body">
                                    <h5 class="card-title text-primary">Selamat Datang, di Sistem Monitoring Kualitas Air
                                    </h5>
                                    <p class="mb-4">
                                    ...
                                    <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                                        <div
                                            ...
                                            <div class="mt-sm-auto">
                                                <a type="button" class="btn rounded-pill btn-outline-primary"
                                                    href="/history">
                                                    <span class="tf-icons bx bx-pie-chart-alt"></span>&nbsp; Lihat Semua
                                                </a>
                                            </div>
                                        </div>
                                        <img src="{{ asset('assets/img/icons/unicons/history.png') }}" alt=""
                                            height="70">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-12 col-md-12 col-lg-12 order-3 order-md-2 ml-2">
                    <div class="row">
                        <div class="col-12 col-md-8 col-lg-6 order-3 order-md-2 ml-2">
                            <div class="card mt-4">
